...
import static songbox.house.domain.entity.user.UserRole.RoleName.ADMIN_ROLE;
...
public class MusicCollectionServiceImpl implements MusicCollectionService {
    ...
    private void checkOwner(final MusicCollection collection) {
        ...
        if (!currentUserName.equals(owner.getUserName()) && !ADMIN_ROLE.equals(owner.getRole().getName())) {
